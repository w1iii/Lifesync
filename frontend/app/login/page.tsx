      ...
      <main className="flex-grow flex items-center justify-center p-4">
        <div className="glass-panel w-full max-w-[480px] rounded-xl p-10 md:p-14 flex flex-col items-center relative overflow-hidden inner-glow">
          <div className="mb-10 text-center">
            ...
            <h1 className="font-display-lg text-display-lg text-primary">LifeSync</h1>
            <p className="font-body-md text-body-md text-on-surface-variant mt-2">Nurturing your digital harmony</p>
          </div>
          ...
          <p className="mt-8 font-body-md text-body-md text-on-surface-variant">
            New to LifeSync?{" "}
            <a className="text-secondary font-bold hover:underline" href="/signup">
              Join the garden
            </a>
          </p>
        </div>
